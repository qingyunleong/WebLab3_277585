...
<body>
    ...
    <div style="max-width:1100px; margin:0 auto;">
        <div class="w3-card w3-container w3-padding w3-margin w3-round">
            ...
            <form>
                <div class="w3-row">
                    <p><input class="w3-input w3-block w3-round w3-border" type="search" name="search" placeholder="Enter search subject" />
                </div>
                <button class="w3-button w3-round w3-right" style="background-color: #133764 ; color:white" type="submit" name="submit" value="search">search</button>
            </form>
        </div>
    </div>
