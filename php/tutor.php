    ...
    <div style="max-width:1100px; margin:0 auto">
        ...
        <div style="background-color: #133764; color:white">
            <div class="w3-container">
                ...
                <p>Find the best online tutor for you choose from our experienced teachers online and get the best learning experience.</p>
            </div>
        </div>
        <br>
        ...
        <div style="max-width:1000px;margin:0 auto;">
            ...
            <div class="w3-grid-template">
                ...
                foreach ($rows as $tutors) {
                    ...
                    echo "<header class='w3-container' style='background-color: #133764 ; color:white'><h5><b>$tutorname</b></h5></header>
                 </div>";
                }
                ?>
            </div>
